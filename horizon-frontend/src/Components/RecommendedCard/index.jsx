  ...
  const recommendedList = carros.map((cars, index) => (
    <div className={recommendedCardStyle.card} key={index}>
      ...
      <div className={recommendedCardStyle.cardText}>
        <div className={recommendedCardStyle.inlineText}>
        ...
        <p className={recommendedCardStyle.carCity}>{cars.cidade.nome}</p>
        <span className={recommendedCardStyle.carDescription}>
          {cars.descricao}
        </span>
